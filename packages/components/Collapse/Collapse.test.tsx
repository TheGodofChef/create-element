...
describe("Collapse.vue", () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll(".ct-collapse-item__header");
    contents = wrapper.findAll(".ct-collapse-item__wrapper");
  ...
  test("手风琴模式", async () => {
    ...
    headers = wrapper.findAll(".ct-collapse-item__header");
    contents = wrapper.findAll(".ct-collapse-item__wapper");
  ...
  test("手风琴模式 错误处理", () => {
    ...
    expect(warn.mock.calls).toMatchInlineSnapshot(
      `
        [
          [
            [CtUIError: [CtCollapse]:accordion mode should only have one active item],
          ],
        ]
      `
    );
