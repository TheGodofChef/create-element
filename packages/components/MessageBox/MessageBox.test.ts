...
describe('MessageBox Component', () => {
	it('renders correctly', async () => {
		...
		MessageBox(props)
		await rAF()
		const header = document.querySelector('.ct-message-box__header')
		const title = document.querySelector('.ct-message-box__title')
		const message = document.querySelector('.ct-message-box__message')
