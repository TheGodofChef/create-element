...
import { type DropdownItemProps } from "create-element";
...
<template>
  <div class="row">
    <div class="col">
      ...
      <ct-dropdown :items="items">
        <span class="dropdown-link">
          Dropdown List
          <ct-icon icon="angle-down" />
        </span>
      </ct-dropdown>
    </div>
    <div class="col">
      <div class="desc">click to trigger</div>
      <ct-dropdown :items="items" trigger="click">
        <span class="dropdown-link">
          Dropdown List
          <ct-icon icon="angle-down" />
        </span>
    ...
    <div class="col">
      ...
      <ct-dropdown :items="items" trigger="contextmenu">
        <span class="dropdown-link">
          Dropdown List
          <ct-icon icon="angle-down" />
        </span>
